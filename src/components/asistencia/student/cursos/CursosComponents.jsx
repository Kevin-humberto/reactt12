...
const MetricCard = ({ title, count, description, icon: Icon, colorClass }) => {
    // Definir estilos según el tipo de métrica
    const getCardStyle = () => {
        switch(colorClass) {
...
const CourseCard = ({ course }) => {
    ...
    const { courseId, title, codigo, docente, aula, horario, asistencia, proximaClase, estado } = course;
    ...
    return (
        ...
        >
            ...
            {/* Barra de Progreso de Inasistencia */}
            ...
            {/* Footer: Próxima Clase y Acciones */}
...
const CursosComponent = ({ data }) => {
    ...
    const metricIcons = {
        ...
        'Cursos Críticos': { icon: ExclamationTriangleIcon, class: 'card-cursos-criticos', description: 'Riesgo de desaprobación' },
    };
