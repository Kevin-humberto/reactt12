...
const JustificationBatchPage = () => {
  ...
  const [filter, setFilter] = useState('all'); // all, pending, approved, partial, rejected
  ...
  const fetchBatches = async () => {
    ...
    try {
      // 🚨 CORRECCIÓN: Usamos el ID de estudiante 6 para ser consistente
      const studentId = 6;
  ...
  return (
    <div className="justification-batch-page">
      ...
      {/* ====== FORMULARIO DE NUEVA SOLICITUD AGRUPADA ====== */}
